...
contactForm.addEventListener('submit', (e) => {
    ...
    const mailtoLink = `mailto:sohilkhan99jait@gmail.com?subject=${subject}&body=${body}`;
...
function showNotification(message, type = 'success') {
    ...
    notification.style.cssText = `
        ...
        top: 100px;
        right: 20px;
        background: linear-gradient(135deg, hsl(250, 84%, 54%), hsl(340, 82%, 52%));
        color: white;
        padding: 1rem 2rem;
        border-radius: 1rem;
...
scrollTopBtn.addEventListener('mouseenter', () => {
    ...
    scrollTopBtn.style.boxShadow = '0 6px 30px rgba(99, 102, 241, 0.6)';
});
...
console.log('💼 Sohil Khan - Full Stack Developer & DevOps Engineer');
console.log('📧 Contact: sohilkhan99jait@gmail.com');
